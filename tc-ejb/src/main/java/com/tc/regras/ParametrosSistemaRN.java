...
import tc.common.exceptions.RegrasException;
import tc.common.logger.ALogger;
import tc.common.util.BigDecimalUtil;
import tc.common.util.IntegerUtil;
...
public class ParametrosSistemaRN {
	...
	public void gravaParametroSistema(ParametrosSistema parametrosSistema) throws RegrasException {
		try {
			...
			throw new RegrasException("Falha ao Gravar Parametro de Sistema ["+parametrosSistema.getParametro().getDesParametro() + ", Valor: " + parametrosSistema.getDesValorParametro(), e);
		}
	}
	...
	public Long buscarPorLongNoBanco(Integer idParamero, Long lngDefault) {
		...
		try {
			...
			if ((param == null) || ((param != null) && (StringUtils.trimToEmpty(param.getDesValorParametro()).isEmpty())))
				return lngDefault;
