...
public class JExtenso {
	...
	private static ALogger		log					= ALogger.getLogger(JExtenso.class);
	
	private ArrayList<Object>	nro;
	 ...
	 */
	public void show() {
		Iterator<Object> valores = nro.iterator();
		
		while (valores.hasNext()) {
			log.info(((Integer) valores.next()).intValue());
		}
		log.info(toString());
	}
