...
public class HostUIFrame extends JFrame {
	...
	/**
	 * Maintains the enbabled/disabled state of key controls, depending on
	 * whether the sim is running or stopped.
	 */
	...
	void btn_Exit_actionPerformed(ActionEvent e) {
		m_owner.addBehaviour(new OneShotBehaviour() {
			private static final long serialVersionUID = -6626574350124680330L;
