...
public class BbGlobais {
	 ...
	 */
	private final String PAGINA_ACESSO_NEGADO = "/publico/AcessoNegado.jsf";

	/**
	 * Endereço para a página de cadastro de alunos
	 */
	private final String PAGINA_CADASTRO_ALUNO = "/publico/cadastroaluno.jsf";
	
	/**
	 * Endereço para a página de cadastro de professor
	 */
	private final String PAGINA_CADASTRO_PROFESSOR = "/publico/cadastroprofessor.jsf";
	
	/**
	 * Endereço para a página de login
	 */
	private final String PAGINA_LOGIN = "/publico/login.jsf";
	
	/**
	 * Endereço para a página de erro ao efetuar login
	 */
	private final String PAGINA_LOGIN_ERROR = "/publico/loginError.jsf";
